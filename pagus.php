            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-lg-auto">
                    ...
                    <li class="nav-item">
                     ...
                     <li class="nav-item">
                        <a href="" class="nav-link smoothScroll"><td><?php echo $id;?></td></a>
                    </li>
                 <li class="nav-item">
                        <a href="#contact" class="nav-link smoothScroll"><td><?php echo $nombre;?></td></a>
                    </li>
                </ul>
                    ...
                    <div class="row">
                         ...
                         <div class="col-lg-8 col-md-10 mx-auto col-12">
                              <div class="hero-text mt-5 text-center">
                                    ...
                                    <h6 data-aos="fade-up" data-aos-delay="300"> La vida comienza al final de tu zona de confort</h6>
